...
See the inlined references below for examples and mocking guidelines.
...
**2. Prefer SDK-style interfaces over generic fetchers** — specific functions per external operation:
```typescript
